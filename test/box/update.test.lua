...
t = box.tuple.new({1, 1.1})
t:update({{'+', 2, 0.1}, {'+', 2, 0.2}})
t = box.tuple.new({1, 0.9})
t:update({{'+', 2, 0.2}, {'-', 2, 0.3}})
t = box.tuple.new({1, decimal.new('1.1000000000000001')})
t:update({{'+', 2, 0.1}, {'+', 2, 0.2}})
t = box.tuple.new({1, decimal.new('0.9000000000000001')})
t:update({{'+', 2, 0.2}, {'-', 2, 0.3}})
t = box.tuple.new({1, 0x1})
t:update({{'|', 2, 0x10}, {'|', 2, 0x100}})
t = box.tuple.new({1, 0x111})
t:update({{'&', 2, 0x110}, {'&', 2, 0x101}})
t = box.tuple.new({1, 0x0})
t:update({{'^', 2, 0x1}, {'^', 2, 0x10}})
t = box.tuple.new({1, 0x101})
t:update({{'|', 2, 0x10}, {'&', 2, 0x110}})
t = box.tuple.new({1,'aa11bbb222zzzzz'})

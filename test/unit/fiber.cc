...
#ifndef NDEBUG
	is(fiber_debug_enabled, true, "fiber_debug_enabled default");
	is(fiber_abort_on_gc_leak, true, "fiber_abort_on_gc_leak default");
#else
	is(fiber_debug_enabled, false, "fiber_debug_enabled default");
	is(fiber_abort_on_gc_leak, false, "fiber_abort_on_gc_leak default");
#endif
...
fiber_test_leak(bool backtrace_enabled)
{
	...
	bool debug_save = fiber_debug_enabled;
	fiber_debug_enabled = backtrace_enabled;
	...
	fiber_abort_on_gc_leak = true;
	fiber_debug_enabled = debug_save;
	...
	if (backtrace_enabled) {
		...
		const char *msg =
			...
			"Make sure fiber.debug_enable() is called before"
...
fiber_test_leak_modes()
{
	...
	fiber_test_leak(true /* backtrace_enabled */);
	fiber_test_leak(false /* backtrace_enabled */);
